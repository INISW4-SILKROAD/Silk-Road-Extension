...
chrome.contextMenus.onClicked.addListener(function (info, tab) {
  if (info.menuItemId === "clickImage") {
    ...
    var _productId = extractProductId(imageUrl);
    if (_productId) {
      // const pageUrl = `https://www.musinsa.com/app/goods/${productId}`;
      console.log("Image URL: ".concat(imageUrl));
      console.log("Id: ".concat(_productId));
      // console.log(`Page URL: ${pageUrl}`);
      sendImageDataToServer(imageUrl, _productId);
    } else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d5380cd6ef9035a293fc")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.4831ba8c4c09827408cd.hot-update.js.map