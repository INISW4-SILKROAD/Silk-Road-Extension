...
}`, "",{"version":3,"sources":["webpack://./src/popup/css/Detail.css"],"names":[],"mappings":"AAAA;EACE,yBAAyB;AAC3B;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,aAAa;EACb,wBAAwB;AAC1B;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,aAAa;EACb,2BAA2B;EAC3B,aAAa;EACb,yBAAyB;AAC3B;;AAEA;EACE,2EAAwE;EACxE,wBAAwB;EACxB,YAAY;EACZ,WAAW,EAAE,aAAa;EAC1B,YAAY,EAAE,aAAa;EAC3B,eAAe;EACf,mBAAmB;AACrB;;;AAGA;EACE,gBAAgB;EAChB,YAAY,EAAE,YAAY;EAC1B,aAAa;EACb,aAAa;EACb,uBAAuB,EAAE,WAAW;AACtC;;AAEA;EACE,uBAAuB;EACvB,iBAAiB,EAAE,iBAAiB;EACpC,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;EAClB,cAAc;EACd,8BAA8B;AAChC;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;EACzB,cAAc;EACd,kBAAkB;EAClB,eAAe;EACf,eAAe;EACf,YAAY;EACZ,mBAAmB;EACnB,8BAA8B;AAChC;;AAEA;EACE,yBAAyB;EACzB,cAAc;AAChB;;;AAGA;EACE,sBAAsB;EACtB,+DAA4C;AAC9C;;AAEA;EACE,2BAA2B;EAC3B,+DAA2E;AAC7E;;AAEA;EACE,8BAA8B;EAC9B,+DAA8E;AAChF","sourcesContent":["#root {\n  background-color: #0B132B;\n}\n\n.detail-container {\n  width: 500px;\n  height: 800px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 20px;\n  background-color: 0B132B;\n}\n\n.navbar {\n  width: 100%;\n  height: 15px;\n  display: flex;\n  justify-content: flex-start;\n  padding: 10px;\n  background-color: #0B132B;\n}\n\n.back-button {\n  background: url('~/public/left_arrow_white.png') no-repeat center center;\n  background-size: contain;\n  border: none;\n  width: 30px; /* 버튼 크기 조정 */\n  height: 30px; /* 버튼 크기 조정 */\n  cursor: pointer;\n  border-radius: 90px;\n}\n\n\n.image-container {\n  margin-top: 35px;\n  width: 400px; /* 컨테이너 너비 */\n  height: 350px;\n  display: flex;\n  justify-content: center; /* 가운데 정렬 */\n}\n\n.product-image {\n  /* max-width: 300px;  */\n  max-height: 150px; /* 이미지 최대 높이 지정 */\n  object-fit: contain;\n}\n\n.product-info {\n  margin-top: 20px;\n  text-align: center;\n  color: #FFFFFF;\n  font-family: 'laundry-regular';\n}\n\n.tactile-info-container {\n  margin-top: 20px;\n}\n\n.view-product-button {\n  margin-top: 20px;\n  background-color: #000000;\n  color: #FFFFFF;\n  padding: 10px 20px;\n  cursor: pointer;\n  font-size: 16px;\n  width: 220px;\n  border-radius: 18px;\n  font-family: 'laundry-regular';\n}\n\n.view-product-button:hover {\n  background-color: #FFFFFF;\n  color: #000000;\n}\n\n\n@font-face {\n  font-family: 'yangjin';\n  src: url('~/yangjin.otf') format('truetype');\n}\n\n@font-face {\n  font-family: 'laundry-bold';\n  src: url('/Users/kdj/Desktop/silkroad/laundry_bold.ttf') format('truetype');\n}\n\n@font-face {\n  font-family: 'laundry-regular';\n  src: url('/Users/kdj/Desktop/silkroad/laundry_regular.ttf') format('truetype');\n}"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8151f71713abe9b0b1ba")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.54abe5980784b4bcd391.hot-update.js.map