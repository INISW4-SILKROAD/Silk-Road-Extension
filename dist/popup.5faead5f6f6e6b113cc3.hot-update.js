...
var TouchInfo = function TouchInfo(_ref) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (!productId) return;
    var fetchTouchInfo = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("http://127.0.0.1:5001/touchinfo/".concat(productId));
            case 3:
            ...
            case 6:
              data = _context.sent;
              if (data.touchInfo) {
                setTouchInfo(data.touchInfo.map(function (info) {
                  return info + 1;
                }));
                setError(false);
              } else {
            ...
            case 10:
              ...
              console.error('Error fetching touch info:', _context.t0);
              setError(true);
            case 14:
            case "end":
      ...
      return function fetchTouchInfo() {
  ...
  }, touchInfo ? touchInfo.map(function (value, index) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: index,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("93ef021594c2a3dc82ae")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.5faead5f6f6e6b113cc3.hot-update.js.map