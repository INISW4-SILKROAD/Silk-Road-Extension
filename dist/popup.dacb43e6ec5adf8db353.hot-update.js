...
var TouchInfo = function TouchInfo() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "bar red",
    style: {
      width: "".concat(touchData.hardness / 5 * 100, "%")
    }
    ...
    className: "bar green",
    style: {
      width: "".concat(touchData.roughness / 5 * 100, "%")
    }
    ...
    className: "bar blue",
    style: {
      width: "".concat(touchData.thickness / 5 * 100, "%")
    }
    ...
    style: {
      width: "".concat(touchData.elasticity / 5 * 100, "%")
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("458cc0f07eeb4ef40b92")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.dacb43e6ec5adf8db353.hot-update.js.map