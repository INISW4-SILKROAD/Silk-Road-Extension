...
___CSS_LOADER_EXPORT___.push([module.id, `/* .detail-container {
  ...
  `, "",{"version":3,"sources":["webpack://./src/popup/css/Detail.css"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;KAwEK;;;EAGH;IACE,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,aAAa;EACf;;EAEA;IACE,WAAW;IACX,aAAa;IACb,2BAA2B;IAC3B,aAAa;IACb,yBAAyB;IACzB,6BAA6B;EAC/B;;EAEA;IACE,yBAAyB;IACzB,YAAY;IACZ,YAAY;IACZ,kBAAkB;IAClB,eAAe;IACf,eAAe;EACjB;;EAEA;IACE,yBAAyB;EAC3B;;EAEA;IACE,gBAAgB;EAClB;;EAEA;IACE,gBAAgB;IAChB,kBAAkB;EACpB;;EAEA;IACE,gBAAgB;EAClB;;EAEA;IACE,gBAAgB;IAChB,yBAAyB;IACzB,YAAY;IACZ,YAAY;IACZ,kBAAkB;IAClB,eAAe;IACf,eAAe;EACjB;;EAEA;IACE,yBAAyB;EAC3B","sourcesContent":["/* .detail-container {\n    font-family: Arial, sans-serif;\n    margin: 0;\n    padding: 20px;\n    box-sizing: border-box;\n    background-color: #f5f5f5;\n    color: #333;\n    width: 100%;\n    max-width: 400px;\n    border-radius: 8px;\n    box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\n  }\n  \n  .image-container img {\n    width: 100%;\n    border-radius: 8px;\n  }\n  \n  .product-info {\n    text-align: center;\n    margin: 20px 0;\n  }\n  \n  .category {\n    font-size: 0.9em;\n    color: #777;\n  }\n  \n  .product-name {\n    font-size: 1.5em;\n    margin: 10px 0;\n  }\n  \n  .product-name span {\n    font-size: 0.8em;\n    color: #777;\n  }\n  \n  .price {\n    font-size: 1.2em;\n    color: #333;\n    margin: 10px 0;\n  }\n  \n  .tactile-info-container {\n    background-color: #000;\n    color: #fff;\n    padding: 20px;\n    border-radius: 8px;\n  }\n  \n  .tactile-info-container h2 {\n    margin: 0 0 10px 0;\n    font-size: 1.2em;\n  }\n  \n  .view-product-button {\n    display: block;\n    width: 100%;\n    background-color: #333;\n    color: #fff;\n    border: none;\n    border-radius: 8px;\n    padding: 10px;\n    font-size: 1em;\n    cursor: pointer;\n    margin-top: 20px;\n    text-align: center;\n  }\n  \n  .view-product-button:hover {\n    background-color: #555;\n  } */\n\n\n  .detail-container {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    padding: 20px;\n  }\n  \n  .navbar {\n    width: 100%;\n    display: flex;\n    justify-content: flex-start;\n    padding: 10px;\n    background-color: #f8f8f8;\n    border-bottom: 1px solid #ddd;\n  }\n  \n  .back-button {\n    background-color: #007bff;\n    color: white;\n    border: none;\n    padding: 10px 20px;\n    cursor: pointer;\n    font-size: 16px;\n  }\n  \n  .back-button:hover {\n    background-color: #0056b3;\n  }\n  \n  .image-container {\n    margin-top: 20px;\n  }\n  \n  .product-info {\n    margin-top: 20px;\n    text-align: center;\n  }\n  \n  .tactile-info-container {\n    margin-top: 20px;\n  }\n  \n  .view-product-button {\n    margin-top: 20px;\n    background-color: #28a745;\n    color: white;\n    border: none;\n    padding: 10px 20px;\n    cursor: pointer;\n    font-size: 16px;\n  }\n  \n  .view-product-button:hover {\n    background-color: #218838;\n  }\n  "],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("476ef7ed35d1c704f0a9")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.d8f9f447c9aa8240d8c6.hot-update.js.map