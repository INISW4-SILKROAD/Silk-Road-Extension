...
//         touchModelResponse: JSON.stringify(data.touchModelResponse),
...
//       if (result.searchResults) {
//         console.log(`Data fetched after ${Date.now() - result.lastFetchTime} ms`);
//         sendResponse({ data: result.searchResults, touchData: result.touchModelResponse });
//       } else {
//         sendResponse({ error: 'No search results found' });
//       }
//     });
    ...
    chrome.storage.local.get(['searchResults', 'touchModelResponse', 'lastFetchTime'], function (result) {
      if (result.searchResults) {
        ...
        sendResponse({
          ...
          touchData: result.touchModelResponse
        });
      } else {
        sendResponse({
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("e5a47af30c6647f9e04e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.05a4f5c67a3a7d41a8c3.hot-update.js.map