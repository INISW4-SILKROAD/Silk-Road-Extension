  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(imageUrl, pageUrl, productId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          data = _context.sent;
          console.log("이미지 링크 전송 성공", data);
          chrome.storage.local.set({
            searchResults: data
          }, function () {
            console.log("Storage set for search initiation, sending startSearch message");
            // 팝업을 새로고침하는 대신, 새로고침 메시지를 보냅니다.
...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
  if (message.action === 'fetchGoods') {
    chrome.storage.local.get(['searchResults'], function (result) {
      console.log("Fetching goods from storage", result);
      if (result.searchResults) {
        sendResponse({
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("27a813ad57aee3048328")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.591d4bb99592b4098fa7.hot-update.js.map