...
var TouchInfo = function TouchInfo() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "bar",
    style: {
      backgroundColor: getColor(touchData.hardness),
    ...
    className: "bar",
    style: {
      backgroundColor: getColor(touchData.roughness),
    ...
    className: "bar",
    style: {
      backgroundColor: getColor(touchData.thickness),
    ...
    className: "bar",
    style: {
      backgroundColor: getColor(touchData.elasticity),
...
`, "",{"version":3,"sources":["webpack://./src/popup/css/TouchInfo.css"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA6CI;AACJ;EACE,yBAAyB;EACzB,aAAa;EACb,kBAAkB;EAClB,YAAY;EACZ,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;EACnB,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,aAAa;EACb,cAAc;AAChB;;AAEA;EACE,YAAY;EACZ,cAAc;EACd,kBAAkB;EAClB,sBAAsB,EAAE,WAAW;AACrC;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,wBAAwB;AAC1B","sourcesContent":["/* .touch-info {\n    background-color: #000000;\n    padding: 20px;\n    border-radius: 8px;\n    width: 460px;\n    height: 180px;\n    margin-bottom: 20px;\n  }\n  \n  .touch-info h2 {\n    font-size: 1.5em;\n    margin-bottom: 10px;\n    color: #FFFFFF;\n  }\n  \n  .touch-bar {\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    margin: 5px 0;\n    color: #FFFFFF;\n  }\n  \n  .bar {\n    flex-grow: 1;\n    height: 15px;\n    margin: 0 10px;\n    border-radius: 5px;\n  }\n  \n  .red {\n    background-color: red;\n  }\n  \n  .green {\n    background-color: green;\n  }\n  \n  .blue {\n    background-color: blue;\n  }\n  \n  .purple {\n    background-color: purple;\n  }\n   */\n.touch-info {\n  background-color: #000000;\n  padding: 20px;\n  border-radius: 8px;\n  width: 460px;\n  height: auto;\n  margin-bottom: 20px;\n}\n\n.touch-info h2 {\n  font-size: 1.5em;\n  margin-bottom: 10px;\n  color: #FFFFFF;\n}\n\n.touch-bar {\n  display: flex;\n  align-items: center;\n  margin: 5px 0;\n  color: #FFFFFF;\n}\n\n.bar {\n  height: 15px;\n  margin: 0 10px;\n  border-radius: 5px;\n  background-color: grey; /* 기본 배경색 */\n}\n\n.red {\n  background-color: red;\n}\n\n.green {\n  background-color: green;\n}\n\n.blue {\n  background-color: blue;\n}\n\n.purple {\n  background-color: purple;\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8a010a914f154f3990b9")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.f81b65a305d7f4b246e4.hot-update.js.map