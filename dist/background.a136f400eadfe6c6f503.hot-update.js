...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  if (request.action === 'fetchGoods') {
    fetch('http://your-azure-vm-public-ip:5000/goods').then(function (response) {
      if (!response.ok) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("00d1daf4bc35faf4d757")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.a136f400eadfe6c6f503.hot-update.js.map