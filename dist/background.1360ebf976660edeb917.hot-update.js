...
var sendImageDataToServer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(imageUrl, pageId) {
    var response, data;
...
chrome.contextMenus.onClicked.addListener(function (info, tab) {
  if (info.menuItemId === "clickImage") {
    ...
    if (productId) {
      ...
      var pageId = productId; // 상품 ID를 직접 사용
      sendImageDataToServer(imageUrl, pageId);
    } else {
      console.error("이미지 링크에서 id 추출 실패");
    }
  }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("571b0feab29cf6d5b98f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.1360ebf976660edeb917.hot-update.js.map