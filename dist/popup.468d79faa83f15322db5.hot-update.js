...
/* harmony import */ var _TouchInfo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TouchInfo */ "./src/popup/components/TouchInfo.jsx");
/* harmony import */ var _css_GoodsList_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../css/GoodsList.css */ "./src/popup/css/GoodsList.css");
...
var GoodsList = function GoodsList(_ref) {
    ...
    if (chrome && chrome.runtime && chrome.runtime.sendMessage) {
      chrome.runtime.sendMessage({
        ...
        if (response && response.error) {
          ...
          fetchData(gids);
          if (response.touchInfo !== undefined) {
            setTouchInfo(response.touchInfo);
            console.log('Touch info:', response.touchInfo);
          }
        }
      });
    } else {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_TouchInfo__WEBPACK_IMPORTED_MODULE_1__["default"], {
    touchInfo: touchInfo
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("cd9450a0fa9cdd9d3a16")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.468d79faa83f15322db5.hot-update.js.map