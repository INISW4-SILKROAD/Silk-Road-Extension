...
var TouchInfo = function TouchInfo(_ref) {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('http://127.0.0.1:5001/submit', {
                  productId: productId
                });
              case 3:
                response = _context.sent;
                product = response.data.product;
                console.log("서버에서 받은 촉감 데이터:", product);
                if (product) {
                  setTouchData({
                    softness: product.SOFTNESS || 0,
                    smoothness: product.SMOOTHNESS || 0,
                    thickness: product.THICKNESS || 0,
                    flexibility: product.FLEXIBILITY || 0
                  });
                }
                _context.next = 12;
                break;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: key,
      className: "touch-bar"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, key.charAt(0).toUpperCase() + key.slice(1)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("5ea8d7ef746a72bc8221")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.8b2a1c5f537d4bb5c9c4.hot-update.js.map