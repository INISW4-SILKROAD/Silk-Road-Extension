...
//         chrome.runtime.sendMessage({ action: 'updateMain' });
//       });
//     } else {
...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
  ...
  if (message.action === 'navigateNone') {
    chrome.tabs.create({
      url: "chrome-extension://<extension-id>/index.html#/none"
    });
  }
});
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b903875e711b537fedba")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.1bb50dd2156c3a971ff4.hot-update.js.map