...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
  if (message.action === 'fetchGoods') {
    chrome.storage.local.get(['searchResults', 'lastFetchTime'], function (result) {
      if (result.searchResults) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("23ee2d797dd434c93670")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.83ff8769c6fed21ff18f.hot-update.js.map