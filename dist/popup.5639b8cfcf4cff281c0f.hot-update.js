  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    var fetchProduct = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, data, _data$touchModelRespo, softness, smoothness, thickness, flexibility;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              // Fetch touch data from the server
              if (data.touchModelResponse) {
                _data$touchModelRespo = _slicedToArray(data.touchModelResponse, 4), softness = _data$touchModelRespo[0], smoothness = _data$touchModelRespo[1], thickness = _data$touchModelRespo[2], flexibility = _data$touchModelRespo[3];
                setTouchData({
                  softness: softness + 1,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c6506f8605d5deac1401")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.5639b8cfcf4cff281c0f.hot-update.js.map