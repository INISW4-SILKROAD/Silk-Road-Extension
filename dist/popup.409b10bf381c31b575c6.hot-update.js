...
var Detail = function Detail() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    fetch("http://127.0.0.1:5001/goods/".concat(id)).then(function (response) {
      ...
      console.log('Fetched data:', data); // 데이터 확인을 위해 로그 출력
      if (data && data.product && data.images) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("878b0a0612e4abd4507d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.409b10bf381c31b575c6.hot-update.js.map