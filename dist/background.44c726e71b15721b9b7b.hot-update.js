...
chrome.contextMenus.onClicked.addListener(function (info, tab) {
  if (info.menuItemId === "clickImage") {
    var _imageUrl = info.srcUrl;
    var productId = extractProductId(_imageUrl);
    if (productId) {
      var pageUrl = "https://www.musinsa.com/app/goods/".concat(productId);
      console.log("Image URL: ".concat(_imageUrl));
      console.log("Page URL: ".concat(pageUrl));
      console.log("Product ID: ".concat(productId));
      sendImageDataToServer(_imageUrl, pageUrl, productId);
    } else {
...
// background.js
// 이미지 검색 결과 수신 후 메시지 전송
axios.post('http://127.0.0.1:5002/search', {
  image_url: imageUrl
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("e3cde678882b4ecd5e04")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.44c726e71b15721b9b7b.hot-update.js.map