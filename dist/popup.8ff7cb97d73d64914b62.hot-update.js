...
___CSS_LOADER_EXPORT___.push([module.id, `.goods-list-container {
  ...
  }`, "",{"version":3,"sources":["webpack://./src/popup/css/GoodsList.css"],"names":[],"mappings":"AAAA;IACI,iBAAiB;IACjB,YAAY;IACZ,aAAa;IACb,+BAA+B;IAC/B,kBAAkB;IAClB,yBAAyB;EAC3B;;EAEA;IACE,aAAa;IACb,6BAA6B;IAC7B,mBAAmB;EACrB;;EAEA;IACE,yBAAyB;IACzB,cAAc;IACd,YAAY;IACZ,kBAAkB;IAClB,mBAAmB;IACnB,eAAe;IACf,iBAAiB;IACjB,eAAe;IACf,iBAAiB;EACnB;;EAEA;IACE,yBAAyB;IACzB,cAAc;EAChB;;EAEA;IACE,aAAa;IACb,eAAe;IACf,6BAA6B;;EAE/B;;EAEA;IACE,UAAU;IACV,mBAAmB;IACnB,kBAAkB;IAClB,eAAe;IACf,yBAAyB;IACzB,cAAc;IACd,eAAe;IACf,mBAAmB;IACnB,iBAAiB;EACnB;;EAEA;IACE,WAAW;IACX,4BAA4B,EAAE,kBAAkB;IAChD,6BAA6B,EAAE,mBAAmB;EACpD;;EAEA;IACE,kBAAkB;IAClB,gBAAgB;EAClB;;EAEA;IACE,cAAc;IACd,gBAAgB;IAChB,WAAW;EACb;;;;EAIA;IACE,iBAAiB;IACjB,+DAAqF;EACvF;;EAEA;IACE,iBAAiB;IACjB,+DAAoF;EACtF","sourcesContent":[".goods-list-container {\n    margin-top: -10px;\n    width: 500px;\n    padding: 20px;\n    /* background-color: #ffffff; */\n    /* color: black; */\n    /* border-radius: 15px; */\n  }\n  \n  .category-buttons {\n    display: flex;\n    justify-content: space-around;\n    margin-bottom: 20px;\n  }\n  \n  .category-button {\n    background-color: #20edc7;\n    color: #1e1f23;\n    border: none;\n    padding: 10px 20px;\n    border-radius: 40px;\n    cursor: pointer;\n    font-weight: bold;\n    font-size: 12pt;\n    font-family: 'f5';\n  }\n  \n  .category-button:hover {\n    background-color: #FFFFFF;\n    color: #000000;\n  }\n  \n  .goods-list {\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: space-around;\n  \n  }\n  \n  .goods-item {\n    width: 45%;\n    margin-bottom: 20px;\n    text-align: center;\n    cursor: pointer;\n    background-color: #FFFFFF;\n    color: #000000;\n    font-size: 11pt;\n    border-radius: 15px;\n    font-family: 'f4';\n  }\n  \n  .goods-item img {\n    width: 100%;\n    border-top-left-radius: 15px; /* 상단 왼쪽 모서리 둥글게 */\n    border-top-right-radius: 15px; /* 상단 오른쪽 모서리 둥글게 */\n  }\n  \n  .goods-item p {\n    margin: 10px 0 0 0;\n    font-size: 0.9em;\n  }\n  \n  .goods-item p span {\n    display: block;\n    font-size: 0.8em;\n    color: #aaa;\n  }\n  \n\n\n  @font-face {\n    font-family: 'f4';\n    src: url('/Users/kdj/Desktop/silkroad/Freesentation-4Regular.ttf') format('truetype');\n  }\n  \n  @font-face {\n    font-family: 'f5';\n    src: url('/Users/kdj/Desktop/silkroad/Freesentation-5Medium.ttf') format('truetype');\n  }"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8a94750754fc943e8751")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.8ff7cb97d73d64914b62.hot-update.js.map