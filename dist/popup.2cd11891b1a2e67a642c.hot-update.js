...
var TouchInfo = function TouchInfo(_ref) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (touchInfo && touchInfo.productId === productId) {
      setTouchData({
        softness: touchInfo.touchInfo[0] + 1,
        smoothness: touchInfo.touchInfo[1] + 1,
        thickness: touchInfo.touchInfo[2] + 1,
        flexibility: touchInfo.touchInfo[3] + 1
      });
    }
  }, [touchInfo, productId]);
  var colorMapping = {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8d0527319ce7cb1827df")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.2cd11891b1a2e67a642c.hot-update.js.map