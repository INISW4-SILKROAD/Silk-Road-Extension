...
___CSS_LOADER_EXPORT___.push([module.id, `.goods-list-container {
  ...
  }`, "",{"version":3,"sources":["webpack://./src/popup/css/GoodsList.css"],"names":[],"mappings":"AAAA;IACI,YAAY;IACZ,aAAa;IACb,yBAAyB;IACzB,YAAY;IACZ,mBAAmB;EACrB;;EAEA;IACE,aAAa;IACb,6BAA6B;IAC7B,mBAAmB;EACrB;;EAEA;IACE,yBAAyB;IACzB,cAAc;IACd,YAAY;IACZ,kBAAkB;IAClB,mBAAmB;IACnB,eAAe;IACf,uBAAuB;IACvB,eAAe;IACf,2BAA2B;EAC7B;;EAEA;IACE,yBAAyB;IACzB,cAAc;EAChB;;EAEA;IACE,aAAa;IACb,eAAe;IACf,6BAA6B;;EAE/B;;EAEA;IACE,UAAU;IACV,mBAAmB;IACnB,gBAAgB;IAChB,eAAe;IACf,uBAAuB;IACvB,eAAe;IACf,mBAAmB;IACnB,2BAA2B;;EAE7B;;EAEA;IACE,WAAW;IACX,4BAA4B,EAAE,kBAAkB;IAChD,6BAA6B,EAAE,mBAAmB;EACpD;;EAEA;IACE,kBAAkB;IAClB,gBAAgB;EAClB;;EAEA;IACE,cAAc;IACd,gBAAgB;IAChB,WAAW;EACb;;EAEA;IACE,sBAAsB;IACtB,+DAA4C;EAC9C;;EAEA;IACE,2BAA2B;IAC3B,+DAA2E;EAC7E;;EAEA;IACE,8BAA8B;IAC9B,+DAA8E;EAChF","sourcesContent":[".goods-list-container {\n    width: 450px;\n    padding: 20px;\n    background-color: #1C2541;\n    color: black;\n    border-radius: 15px;\n  }\n  \n  .category-buttons {\n    display: flex;\n    justify-content: space-around;\n    margin-bottom: 20px;\n  }\n  \n  .category-button {\n    background-color: #5BC0BE;\n    color: #1C2541;\n    border: none;\n    padding: 10px 20px;\n    border-radius: 40px;\n    cursor: pointer;\n    /* font-weight: bold; */\n    font-size: 12pt;\n    font-family: 'laundry-bold';\n  }\n  \n  .category-button:hover {\n    background-color: #FFFFFF;\n    color: #000000;\n  }\n  \n  .goods-list {\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: space-around;\n  \n  }\n  \n  .goods-item {\n    width: 45%;\n    margin-bottom: 20px;\n    text-align: left;\n    cursor: pointer;\n    background-color: white;\n    font-size: 10pt;\n    border-radius: 15px;\n    font-family: 'laundry-bold';\n\n  }\n  \n  .goods-item img {\n    width: 100%;\n    border-top-left-radius: 15px; /* 상단 왼쪽 모서리 둥글게 */\n    border-top-right-radius: 15px; /* 상단 오른쪽 모서리 둥글게 */\n  }\n  \n  .goods-item p {\n    margin: 10px 0 0 0;\n    font-size: 0.9em;\n  }\n  \n  .goods-item p span {\n    display: block;\n    font-size: 0.8em;\n    color: #aaa;\n  }\n  \n  @font-face {\n    font-family: 'yangjin';\n    src: url('~/yangjin.otf') format('truetype');\n  }\n\n  @font-face {\n    font-family: 'laundry-bold';\n    src: url('/Users/kdj/Desktop/silkroad/laundry_bold.ttf') format('truetype');\n  }\n\n  @font-face {\n    font-family: 'laundry-regular';\n    src: url('/Users/kdj/Desktop/silkroad/laundry_regular.ttf') format('truetype');\n  }"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("957da313ee0d836c5770")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.3bc17ab715127342d120.hot-update.js.map