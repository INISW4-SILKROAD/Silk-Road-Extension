        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("http://127.0.0.1:5001/goods/".concat(selectedProductId));
            case 4:
              ...
              if (data.touchModelResponse) {
                setTouchData({
                  softness: (data.touchModelResponse[0] || 0) + 1,
                  smoothness: (data.touchModelResponse[1] || 0) + 1,
                  thickness: (data.touchModelResponse[2] || 0) + 1,
                  flexibility: (data.touchModelResponse[3] || 0) + 1
                });
              } else {
                setTouchData({
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("582418c9492d6bff9276")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=popup.6275071715f03b3f4930.hot-update.js.map